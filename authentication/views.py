...
from .utils import token_generator, AppTokenGenerator
    ...
    def post(self, request):
        ...
        if not User.objects.filter(username=username).exists():
            if not User.objects.filter(email=email).exists():
                ...
                email_body = f'Hi {user.username} please use link to verify your account\n {activate_url}'
                email = EmailMessage(
                    email_subject,
                    email_body,
...
class RequestPasswordResetEmail(View):
    ...
    def post(self, request):
        ...
        if user.exists():
            ...
            email_body = f'Hi there, please use link to reset your password\n {reset_url}'
